...
rk_revised <- read_csv("data-raw/check_locations_4ryon_rk.csv") |> 
...
write_csv(survey_locations_revised, "data-raw/survey_locations_revised.csv")

# Ashley used google to QC the coordinates- looked up coordinates by entering 39 (deg symbol) XX.XXN 121 (deg symbol) XX.XXW
survey_locations_google <- read_csv("data-raw/survey_locations_revised_av.csv")
```
...
coordinates_from_kmz_raw <- read_csv("data-raw/Coordinates_Snorkel_Survey_Locations.csv")
...
write_csv(survey_locations_with_latlong, "data/survey_locations.csv")
```

```{r}
ryon_coordinates <- readxl::read_xlsx("data-raw/survey_locations_name_cleanup_rk.xlsx") 
...
write_csv(microhabitat_with_fish_detections, "data/microhabitat_observations.csv")
#write_csv(survey_locations, "data/survey_locations.csv")
write_csv(survey_locations_post_ryon_revisions_qc, "data/survey_locations.csv")
