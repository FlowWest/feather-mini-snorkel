...
locations_ck <- survey_locations_with_latlong |> 
  ...
  rename(rk_latitude = latitude,
    ...
    select(location_table_id, rk_location, rk_location_revised, rk_latitude, rk_longitude))
...
write_csv(survey_locations_post_ryon_revisions, "data/survey_locations.csv")
```
